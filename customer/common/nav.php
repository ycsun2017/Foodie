                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="myPlan.php">My Plans</a></li>
                            <li><a href="myWishList.php">My WishList</a></li>
                            <li><a href="myNotices.php">New Notices</a></li>
    ...
    <div class="sidebar page-sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="myWishList.php"><i class="fa fa-list fa-fw"></i> My Wish List
                    </a>
                </li>
                <li>
                    <a href="myPlan.php"><i class="fa fa-list fa-fw"></i> My Plans
                    </a>
                </li>
                <li >
                    <a href="myComment.php"><i class="fa fa-list fa-fw"></i> My Comments
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="myFollowing.php"><i class="fa fa-user fa-fw"></i> Following
                    </a>
                </li>
                <li>
